...
export interface StructureDefinition extends fhir.DomainResource {
     ...
     */
    fhirVersion?: '0.0.80' | '0.0.81' | '0.0.82' | '0.01' | '0.05' | '0.06' | '0.11' | '0.4.0' | '0.5.0' | '1.0.0' | '1.0.1' | '1.0.2' | '1.1.0' | '1.4.0' | '1.6.0' | '1.8.0' | '3.0.0' | '3.0.1' | '3.0.2' | '3.3.0' | '3.5.0' | '4.0.0' | '4.0.1' | '4.1.0' | '4.3.0' | '4.3.0-cibuild' | '4.3.0-snapshot1' | undefined;
    /**
