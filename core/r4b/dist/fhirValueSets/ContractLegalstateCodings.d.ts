 ...
 */
export declare type ContractLegalstateCodingType = {
    /**
 ...
 * This value set contract specific codes for status.
 */
export declare const ContractLegalstateCodings: ContractLegalstateCodingType;
//# sourceMappingURL=ContractLegalstateCodings.d.ts.map