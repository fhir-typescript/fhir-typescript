 ...
 */
export declare const MeasurePopulationCodes: {
    /**
     ...
     */
    readonly DenominatorException: "denominator-exception";
    /**
     ...
     */
    readonly DenominatorExclusion: "denominator-exclusion";
    /**
     ...
     */
    readonly InitialPopulation: "initial-population";
    /**
     ...
     */
    readonly MeasureObservation: "measure-observation";
    /**
     ...
     */
    readonly MeasurePopulation: "measure-population";
    /**
     ...
     */
    readonly MeasurePopulationExclusion: "measure-population-exclusion";
    /**
     ...
     */
    readonly NumeratorExclusion: "numerator-exclusion";
};
/**
 * The type of population.
 */
export declare type MeasurePopulationCodeType = typeof MeasurePopulationCodes[keyof typeof MeasurePopulationCodes];
//# sourceMappingURL=MeasurePopulationCodes.d.ts.map