...
export declare const GoalPriorityCodes: {
     ...
     */
    readonly LowPriority: "low-priority";
    /**
     ...
     */
    readonly MediumPriority: "medium-priority";
};
/**
 * Indicates the level of importance associated with reaching or sustaining a goal.
 */
export declare type GoalPriorityCodeType = typeof GoalPriorityCodes[keyof typeof GoalPriorityCodes];
//# sourceMappingURL=GoalPriorityCodes.d.ts.map