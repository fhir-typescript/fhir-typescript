 ...
 */
export declare const ProvenanceParticipantRoleCodes: {
    /**
 ...
 * The role that a provenance participant played
 */
export declare type ProvenanceParticipantRoleCodeType = typeof ProvenanceParticipantRoleCodes[keyof typeof ProvenanceParticipantRoleCodes];
//# sourceMappingURL=ProvenanceParticipantRoleCodes.d.ts.map