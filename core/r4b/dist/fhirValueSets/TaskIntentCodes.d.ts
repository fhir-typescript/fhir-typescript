 ...
 */
export declare const TaskIntentCodes: {
    /**
 ...
 * Distinguishes whether the task is a proposal, plan or full order.
 */
export declare type TaskIntentCodeType = typeof TaskIntentCodes[keyof typeof TaskIntentCodes];
//# sourceMappingURL=TaskIntentCodes.d.ts.map