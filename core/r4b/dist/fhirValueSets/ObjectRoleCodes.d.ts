 ...
 */
export declare const ObjectRoleCodes: {
    /**
     ...
     */
    readonly Subscriber: "9";
};
/**
 * Code representing the role the entity played in the audit event.
 */
export declare type ObjectRoleCodeType = typeof ObjectRoleCodes[keyof typeof ObjectRoleCodes];
//# sourceMappingURL=ObjectRoleCodes.d.ts.map