...
export class Task extends fhir.DomainResource {
  ...
  constructor(source:Partial<TaskArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['instantiatesCanonical'] !== undefined) { this.instantiatesCanonical = new fhir.FhirCanonical({value: source.instantiatesCanonical}, options); }
    if (source['_instantiatesCanonical']) {
      ...
      else { this.instantiatesCanonical = new fhir.FhirCanonical(source._instantiatesCanonical as Partial<fhir.FhirCanonicalArgs>, options); }
    }
    ...
    if (source['intent'] !== undefined) { this.intent = new fhir.FhirCode<TaskIntentCodeType>({value: source.intent}, options); }
    else { this.intent = null; }
    if (source['_intent']) {
      if (this.intent) { this.intent.addExtendedProperties(source._intent!); }
      else { this.intent = new fhir.FhirCode<TaskIntentCodeType>(source._intent as Partial<fhir.FhirCode>, options); }
    }
    ...
    if (source['reasonCode']) { this.reasonCode = new fhir.CodeableConcept(source.reasonCode, options); }
    if (source['reasonReference']) { this.reasonReference = new fhir.Reference(source.reasonReference, options); }
