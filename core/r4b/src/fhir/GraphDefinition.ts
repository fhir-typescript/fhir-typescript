...
export class GraphDefinitionLinkTargetCompartment extends fhir.BackboneElement {
  ...
  constructor(source:Partial<GraphDefinitionLinkTargetCompartmentArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['use'] !== undefined) { this.use = new fhir.FhirCode<GraphCompartmentUseCodeType>({value: source.use}, options); }
    else { this.use = null; }
    if (source['_use']) {
      if (this.use) { this.use.addExtendedProperties(source._use!); }
      else { this.use = new fhir.FhirCode<GraphCompartmentUseCodeType>(source._use as Partial<fhir.FhirCode>, options); }
    }
    if (source['code'] !== undefined) { this.code = new fhir.FhirCode<CompartmentTypeCodeType>({value: source.code}, options); }
    else { this.code = null; }
    if (source['_code']) {
      if (this.code) { this.code.addExtendedProperties(source._code!); }
      else { this.code = new fhir.FhirCode<CompartmentTypeCodeType>(source._code as Partial<fhir.FhirCode>, options); }
    }
