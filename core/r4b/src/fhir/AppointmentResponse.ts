...
export class AppointmentResponse extends fhir.DomainResource {
  ...
  constructor(source:Partial<AppointmentResponseArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['participantStatus'] !== undefined) { this.participantStatus = new fhir.FhirCode<ParticipationstatusCodeType>({value: source.participantStatus}, options); }
    ...
    if (source['_participantStatus']) {
      ...
      else { this.participantStatus = new fhir.FhirCode<ParticipationstatusCodeType>(source._participantStatus as Partial<fhir.FhirCode>, options); }
    }
