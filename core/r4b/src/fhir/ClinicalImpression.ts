...
export class ClinicalImpressionFinding extends fhir.BackboneElement {
  ...
  constructor(source:Partial<ClinicalImpressionFindingArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    super(source, options);
    if (source['itemCodeableConcept']) { this.itemCodeableConcept = new fhir.CodeableConcept(source.itemCodeableConcept, options); }
    if (source['itemReference']) { this.itemReference = new fhir.Reference(source.itemReference, options); }
