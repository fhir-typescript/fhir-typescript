...
export class MolecularSequenceReferenceSeq extends fhir.BackboneElement {
  ...
  constructor(source:Partial<MolecularSequenceReferenceSeqArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['orientation'] !== undefined) { this.orientation = new fhir.FhirCode<OrientationTypeCodeType>({value: source.orientation}, options); }
    if (source['_orientation']) {
      if (this.orientation) { this.orientation.addExtendedProperties(source._orientation!); }
      else { this.orientation = new fhir.FhirCode<OrientationTypeCodeType>(source._orientation as Partial<fhir.FhirCode>, options); }
    }
    ...
    if (source['strand'] !== undefined) { this.strand = new fhir.FhirCode<StrandTypeCodeType>({value: source.strand}, options); }
    if (source['_strand']) {
      if (this.strand) { this.strand.addExtendedProperties(source._strand!); }
      else { this.strand = new fhir.FhirCode<StrandTypeCodeType>(source._strand as Partial<fhir.FhirCode>, options); }
    }
...
export class MolecularSequenceQualityRoc extends fhir.BackboneElement {
  ...
  constructor(source:Partial<MolecularSequenceQualityRocArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    super(source, options);
    if (source['score'] !== undefined) { this.score = source.score.map((x) => new fhir.FhirInteger({value: x}, options)); }
    else { this.score = []; }
    if (source['_score']) {
    ...
    if (source['numTP'] !== undefined) { this.numTP = source.numTP.map((x) => new fhir.FhirInteger({value: x}, options)); }
    else { this.numTP = []; }
    if (source['_numTP']) {
    ...
    if (source['numFP'] !== undefined) { this.numFP = source.numFP.map((x) => new fhir.FhirInteger({value: x}, options)); }
    else { this.numFP = []; }
    if (source['_numFP']) {
    ...
    if (source['numFN'] !== undefined) { this.numFN = source.numFN.map((x) => new fhir.FhirInteger({value: x}, options)); }
    else { this.numFN = []; }
    if (source['_numFN']) {
    ...
    if (source['precision'] !== undefined) { this.precision = source.precision.map((x) => new fhir.FhirDecimal({value: x}, options)); }
    else { this.precision = []; }
    ...
    if (source['sensitivity'] !== undefined) { this.sensitivity = source.sensitivity.map((x) => new fhir.FhirDecimal({value: x}, options)); }
    ...
    if (source['fMeasure'] !== undefined) { this.fMeasure = source.fMeasure.map((x) => new fhir.FhirDecimal({value: x}, options)); }
    else { this.fMeasure = []; }
    if (source['_fMeasure']) {
...
export class MolecularSequenceQuality extends fhir.BackboneElement {
  ...
  constructor(source:Partial<MolecularSequenceQualityArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['roc']) { this.roc = new fhir.MolecularSequenceQualityRoc(source.roc, options); }
  }
  /**
   * Function to perform basic model validation (e.g., check if required elements are present).
   */
...
export class MolecularSequenceStructureVariant extends fhir.BackboneElement {
  ...
  constructor(source:Partial<MolecularSequenceStructureVariantArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    super(source, options);
    if (source['variantType']) { this.variantType = new fhir.CodeableConcept(source.variantType, options); }
    if (source['exact'] !== undefined) { this.exact = new fhir.FhirBoolean({value: source.exact}, options); }
    if (source['_exact']) {
      if (this.exact) { this.exact.addExtendedProperties(source._exact!); }
      else { this.exact = new fhir.FhirBoolean(source._exact as Partial<fhir.FhirBooleanArgs>, options); }
    }
    ...
    if (source['outer']) { this.outer = new fhir.MolecularSequenceStructureVariantOuter(source.outer, options); }
    if (source['inner']) { this.inner = new fhir.MolecularSequenceStructureVariantInner(source.inner, options); }
  }
  /**
   * Function to perform basic model validation (e.g., check if required elements are present).
   */
...
export class MolecularSequence extends fhir.DomainResource {
  ...
  constructor(source:Partial<MolecularSequenceArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['type'] !== undefined) { this.type = new fhir.FhirCode<SequenceTypeCodeType>({value: source.type}, options); }
    if (source['_type']) {
      if (this.type) { this.type.addExtendedProperties(source._type!); }
      else { this.type = new fhir.FhirCode<SequenceTypeCodeType>(source._type as Partial<fhir.FhirCode>, options); }
    }
    ...
    if (source['referenceSeq']) { this.referenceSeq = new fhir.MolecularSequenceReferenceSeq(source.referenceSeq, options); }
    if (source['variant']) { this.variant = source.variant.map((x) => new fhir.MolecularSequenceVariant(x, options)); }
    else { this.variant = []; }
    ...
    if (source['quality']) { this.quality = source.quality.map((x) => new fhir.MolecularSequenceQuality(x, options)); }
    else { this.quality = []; }
    ...
    if (source['repository']) { this.repository = source.repository.map((x) => new fhir.MolecularSequenceRepository(x, options)); }
    else { this.repository = []; }
    if (source['pointer']) { this.pointer = source.pointer.map((x) => new fhir.Reference(x, options)); }
    else { this.pointer = []; }
    if (source['structureVariant']) { this.structureVariant = source.structureVariant.map((x) => new fhir.MolecularSequenceStructureVariant(x, options)); }
