...
// @ts-ignore
import { MeasureStratifierExampleVsValidation } from '../fhirValueSets/MeasureStratifierExampleVsValidation.js';
// @ts-ignore
import { MeasureGroupExampleCodes,  MeasureGroupExampleCodeType } from '../fhirValueSets/MeasureGroupExampleCodes.js';
// @ts-ignore
import { MeasureGroupExampleVsValidation } from '../fhirValueSets/MeasureGroupExampleVsValidation.js';
// @ts-ignore
...
// @ts-ignore
import { MeasureSupplementalDataExampleVsValidation } from '../fhirValueSets/MeasureSupplementalDataExampleVsValidation.js';
// @ts-ignore
...
export class MeasureGroupPopulation extends fhir.BackboneElement {
  ...
  constructor(source:Partial<MeasureGroupPopulationArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['criteria']) { this.criteria = new fhir.Expression(source.criteria, options); }
...
export class MeasureGroupStratifier extends fhir.BackboneElement {
  ...
  constructor(source:Partial<MeasureGroupStratifierArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['criteria']) { this.criteria = new fhir.Expression(source.criteria, options); }
    if (source['component']) { this.component = source.component.map((x) => new fhir.MeasureGroupStratifierComponent(x, options)); }
    else { this.component = []; }
  }
  /**
   * Function to perform basic model validation (e.g., check if required elements are present).
