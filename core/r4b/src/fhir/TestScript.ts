...
export class TestScriptMetadataCapability extends fhir.BackboneElement {
  ...
  constructor(source:Partial<TestScriptMetadataCapabilityArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['capabilities'] !== undefined) { this.capabilities = new fhir.FhirCanonical({value: source.capabilities}, options); }
    ...
    if (source['_capabilities']) {
      ...
      else { this.capabilities = new fhir.FhirCanonical(source._capabilities as Partial<fhir.FhirCanonicalArgs>, options); }
    }
  }
  /**
   * Function to perform basic model validation (e.g., check if required elements are present).
...
export class TestScriptSetupActionOperation extends fhir.BackboneElement {
  ...
  constructor(source:Partial<TestScriptSetupActionOperationArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['accept'] !== undefined) { this.accept = new fhir.FhirCode({value: source.accept}, options); }
    if (source['_accept']) {
      if (this.accept) { this.accept.addExtendedProperties(source._accept!); }
      else { this.accept = new fhir.FhirCode(source._accept as Partial<fhir.FhirCodeArgs>, options); }
    }
    ...
    if (source['method'] !== undefined) { this.method = new fhir.FhirCode<HttpOperationsCodeType>({value: source.method}, options); }
    if (source['_method']) {
      if (this.method) { this.method.addExtendedProperties(source._method!); }
      else { this.method = new fhir.FhirCode<HttpOperationsCodeType>(source._method as Partial<fhir.FhirCode>, options); }
    }
