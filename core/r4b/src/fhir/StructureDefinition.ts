...
export class StructureDefinitionContext extends fhir.BackboneElement {
  ...
  constructor(source:Partial<StructureDefinitionContextArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    super(source, options);
    if (source['type'] !== undefined) { this.type = new fhir.FhirCode<ExtensionContextTypeCodeType>({value: source.type}, options); }
    else { this.type = null; }
    if (source['_type']) {
      if (this.type) { this.type.addExtendedProperties(source._type!); }
      else { this.type = new fhir.FhirCode<ExtensionContextTypeCodeType>(source._type as Partial<fhir.FhirCode>, options); }
    }
...
export class StructureDefinition extends fhir.DomainResource {
  ...
  constructor(source:Partial<StructureDefinitionArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['keyword']) { this.keyword = source.keyword.map((x) => new fhir.Coding(x, options)); }
    else { this.keyword = []; }
    ...
    if (source['context']) { this.context = source.context.map((x) => new fhir.StructureDefinitionContext(x, options)); }
    else { this.context = []; }
    if (source['contextInvariant'] !== undefined) { this.contextInvariant = source.contextInvariant.map((x) => new fhir.FhirString({value: x}, options)); }
    ...
    if (source['baseDefinition'] !== undefined) { this.baseDefinition = new fhir.FhirCanonical({value: source.baseDefinition}, options); }
    if (source['_baseDefinition']) {
      if (this.baseDefinition) { this.baseDefinition.addExtendedProperties(source._baseDefinition!); }
      else { this.baseDefinition = new fhir.FhirCanonical(source._baseDefinition as Partial<fhir.FhirCanonicalArgs>, options); }
    }
    if (source['derivation'] !== undefined) { this.derivation = new fhir.FhirCode<TypeDerivationRuleCodeType>({value: source.derivation}, options); }
    if (source['_derivation']) {
      if (this.derivation) { this.derivation.addExtendedProperties(source._derivation!); }
      else { this.derivation = new fhir.FhirCode<TypeDerivationRuleCodeType>(source._derivation as Partial<fhir.FhirCode>, options); }
    }
