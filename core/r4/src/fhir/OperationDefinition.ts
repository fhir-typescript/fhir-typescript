...
export class OperationDefinitionParameterReferencedFrom extends fhir.BackboneElement {
  ...
  constructor(source:Partial<OperationDefinitionParameterReferencedFromArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['sourceId'] !== undefined) { this.sourceId = new fhir.FhirString({value: source.sourceId}, options); }
    if (source['_sourceId']) {
      if (this.sourceId) { this.sourceId.addExtendedProperties(source._sourceId!); }
      else { this.sourceId = new fhir.FhirString(source._sourceId as Partial<fhir.FhirStringArgs>, options); }
    }
  }
  /**
   * Function to perform basic model validation (e.g., check if required elements are present).
...
export class OperationDefinitionParameter extends fhir.BackboneElement {
  ...
  constructor(source:Partial<OperationDefinitionParameterArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['searchType'] !== undefined) { this.searchType = new fhir.FhirCode<SearchParamTypeCodeType>({value: source.searchType}, options); }
    if (source['_searchType']) {
      if (this.searchType) { this.searchType.addExtendedProperties(source._searchType!); }
      else { this.searchType = new fhir.FhirCode<SearchParamTypeCodeType>(source._searchType as Partial<fhir.FhirCode>, options); }
    }
    if (source['binding']) { this.binding = new fhir.OperationDefinitionParameterBinding(source.binding, options); }
    if (source['referencedFrom']) { this.referencedFrom = source.referencedFrom.map((x) => new fhir.OperationDefinitionParameterReferencedFrom(x, options)); }
...
export class OperationDefinitionOverload extends fhir.BackboneElement {
  ...
  constructor(source:Partial<OperationDefinitionOverloadArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    super(source, options);
    if (source['parameterName'] !== undefined) { this.parameterName = source.parameterName.map((x) => new fhir.FhirString({value: x}, options)); }
...
export class OperationDefinition extends fhir.DomainResource {
  ...
  constructor(source:Partial<OperationDefinitionArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['affectsState'] !== undefined) { this.affectsState = new fhir.FhirBoolean({value: source.affectsState}, options); }
    if (source['_affectsState']) {
      if (this.affectsState) { this.affectsState.addExtendedProperties(source._affectsState!); }
      else { this.affectsState = new fhir.FhirBoolean(source._affectsState as Partial<fhir.FhirBooleanArgs>, options); }
    }
    ...
    if (source['base'] !== undefined) { this.base = new fhir.FhirCanonical({value: source.base}, options); }
    if (source['_base']) {
      if (this.base) { this.base.addExtendedProperties(source._base!); }
      else { this.base = new fhir.FhirCanonical(source._base as Partial<fhir.FhirCanonicalArgs>, options); }
    }
    if (source['resource'] !== undefined) { this.resource = source.resource.map((x) => new fhir.FhirCode({value: x}, options)); }
    else { this.resource = []; }
    if (source['_resource']) {
    ...
    if (source['type'] !== undefined) { this.type = new fhir.FhirBoolean({value: source.type}, options); }
    else { this.type = null; }
    if (source['_type']) {
      if (this.type) { this.type.addExtendedProperties(source._type!); }
      else { this.type = new fhir.FhirBoolean(source._type as Partial<fhir.FhirBooleanArgs>, options); }
    }
    ...
    if (source['inputProfile'] !== undefined) { this.inputProfile = new fhir.FhirCanonical({value: source.inputProfile}, options); }
    if (source['_inputProfile']) {
      if (this.inputProfile) { this.inputProfile.addExtendedProperties(source._inputProfile!); }
      else { this.inputProfile = new fhir.FhirCanonical(source._inputProfile as Partial<fhir.FhirCanonicalArgs>, options); }
    }
    if (source['outputProfile'] !== undefined) { this.outputProfile = new fhir.FhirCanonical({value: source.outputProfile}, options); }
    if (source['_outputProfile']) {
      if (this.outputProfile) { this.outputProfile.addExtendedProperties(source._outputProfile!); }
      else { this.outputProfile = new fhir.FhirCanonical(source._outputProfile as Partial<fhir.FhirCanonicalArgs>, options); }
    }
    if (source['parameter']) { this.parameter = source.parameter.map((x) => new fhir.OperationDefinitionParameter(x, options)); }
    else { this.parameter = []; }
    if (source['overload']) { this.overload = source.overload.map((x) => new fhir.OperationDefinitionOverload(x, options)); }
    else { this.overload = []; }
  }
  /**
   * Function to perform basic model validation (e.g., check if required elements are present).
