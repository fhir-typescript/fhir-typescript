...
// @ts-ignore
import { RiskEstimateTypeVsValidation } from '../fhirValueSets/RiskEstimateTypeVsValidation.js';
// @ts-ignore
...
export class RiskEvidenceSynthesisRiskEstimate extends fhir.BackboneElement {
  ...
  constructor(source:Partial<RiskEvidenceSynthesisRiskEstimateArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['denominatorCount'] !== undefined) { this.denominatorCount = new fhir.FhirInteger({value: source.denominatorCount}, options); }
    if (source['_denominatorCount']) {
      if (this.denominatorCount) { this.denominatorCount.addExtendedProperties(source._denominatorCount!); }
      else { this.denominatorCount = new fhir.FhirInteger(source._denominatorCount as Partial<fhir.FhirIntegerArgs>, options); }
    }
    if (source['numeratorCount'] !== undefined) { this.numeratorCount = new fhir.FhirInteger({value: source.numeratorCount}, options); }
    if (source['_numeratorCount']) {
      if (this.numeratorCount) { this.numeratorCount.addExtendedProperties(source._numeratorCount!); }
      else { this.numeratorCount = new fhir.FhirInteger(source._numeratorCount as Partial<fhir.FhirIntegerArgs>, options); }
    }
    if (source['precisionEstimate']) { this.precisionEstimate = source.precisionEstimate.map((x) => new fhir.RiskEvidenceSynthesisRiskEstimatePrecisionEstimate(x, options)); }
...
export class RiskEvidenceSynthesisCertainty extends fhir.BackboneElement {
  ...
  constructor(source:Partial<RiskEvidenceSynthesisCertaintyArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['certaintySubcomponent']) { this.certaintySubcomponent = source.certaintySubcomponent.map((x) => new fhir.RiskEvidenceSynthesisCertaintyCertaintySubcomponent(x, options)); }
...
export class RiskEvidenceSynthesis extends fhir.DomainResource {
  ...
  constructor(source:Partial<RiskEvidenceSynthesisArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['sampleSize']) { this.sampleSize = new fhir.RiskEvidenceSynthesisSampleSize(source.sampleSize, options); }
    if (source['riskEstimate']) { this.riskEstimate = new fhir.RiskEvidenceSynthesisRiskEstimate(source.riskEstimate, options); }
    if (source['certainty']) { this.certainty = source.certainty.map((x) => new fhir.RiskEvidenceSynthesisCertainty(x, options)); }
    else { this.certainty = []; }
  }
  /**
   * Function to perform basic model validation (e.g., check if required elements are present).
