 ...
 */
export const ContractPublicationstatusCodes = {
  /**
 ...
 * This value set contract specific codes for status.
 */
export type ContractPublicationstatusCodeType = typeof ContractPublicationstatusCodes[keyof typeof ContractPublicationstatusCodes];
