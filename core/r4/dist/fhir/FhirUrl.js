...
export class FhirUrl extends fhir.FhirPrimitive {
    ...
    */
    ...
    doModelValidation() {
        ...
        if ((this.value !== undefined) && ((this.value === '') || (typeof this.value !== 'string') || (!FhirUrl._fts_regex.test(this.value)))) {
