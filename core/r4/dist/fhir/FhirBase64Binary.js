...
export class FhirBase64Binary extends fhir.FhirPrimitive {
    ...
    */
    ...
    doModelValidation() {
        ...
        if ((this.value !== undefined) && ((this.value === '') || (typeof this.value !== 'string') || (!FhirBase64Binary._fts_regex.test(this.value)))) {
