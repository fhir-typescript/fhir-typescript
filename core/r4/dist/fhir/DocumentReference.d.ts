...
import { FormatcodesCodingType } from '../fhirValueSets/FormatcodesCodings.js';
...
import { C80DocTypecodesCodingType } from '../fhirValueSets/C80DocTypecodesCodings.js';
...
export declare class DocumentReferenceContent extends fhir.BackboneElement {
     ...
     */
    static formatPreferredCoding(): FormatcodesCodingType;
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(): fhir.OperationOutcome;
...
export declare class DocumentReference extends fhir.DomainResource {
     ...
     */
    static docStatusRequiredCoding(): CompositionStatusCodingType;
    /**
     * Preferred-bound Value Set for type (DocumentReference.type)
     */
    static typePreferredCoding(): C80DocTypecodesCodingType;
    /**
