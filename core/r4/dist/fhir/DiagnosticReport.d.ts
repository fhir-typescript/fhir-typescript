...
import { DiagnosticReportStatusCodingType } from '../fhirValueSets/DiagnosticReportStatusCodings.js';
import { DiagnosticReportStatusCodeType } from '../fhirValueSets/DiagnosticReportStatusCodes.js';
import { ReportCodesCodingType } from '../fhirValueSets/ReportCodesCodings.js';
/**
...
export declare class DiagnosticReport extends fhir.DomainResource {
     ...
     */
    static statusRequiredCoding(): DiagnosticReportStatusCodingType;
    /**
     * Preferred-bound Value Set for code (DiagnosticReport.code)
     */
    static codePreferredCoding(): ReportCodesCodingType;
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(): fhir.OperationOutcome;
