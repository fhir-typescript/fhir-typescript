...
import { ParticipantrequiredCodingType } from '../fhirValueSets/ParticipantrequiredCodings.js';
...
import { AppointmentstatusCodingType } from '../fhirValueSets/AppointmentstatusCodings.js';
...
export declare class AppointmentParticipant extends fhir.BackboneElement {
     ...
     */
    static requiredRequiredCoding(): ParticipantrequiredCodingType;
    /**
     * Required-bound Value Set for status (Appointment.participant.status)
     */
    static statusRequiredCoding(): ParticipationstatusCodingType;
    /**
...
export declare class Appointment extends fhir.DomainResource {
     ...
     */
    static statusRequiredCoding(): AppointmentstatusCodingType;
    /**
