...
import { ResearchElementTypeCodingType } from '../fhirValueSets/ResearchElementTypeCodings.js';
...
export declare class ResearchElementDefinitionCharacteristic extends fhir.BackboneElement {
     ...
     */
    static studyEffectiveGroupMeasureRequiredCoding(): GroupMeasureCodingType;
    /**
     ...
     */
    static participantEffectiveGroupMeasureRequiredCoding(): GroupMeasureCodingType;
    /**
...
export declare class ResearchElementDefinition extends fhir.DomainResource {
     ...
     */
    static typeRequiredCoding(): ResearchElementTypeCodingType;
    /**
     * Required-bound Value Set for variableType (ResearchElementDefinition.variableType)
     */
    static variableTypeRequiredCoding(): VariableTypeCodingType;
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(): fhir.FtsIssue[];
