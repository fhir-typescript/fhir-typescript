    ...
    */
    ...
    doModelValidation(expression = '') {
        ...
        if ((this.value !== undefined) && (this.value !== null) && ((this.value === '') || (typeof this.value !== 'string') || (!FhirCode._fts_regex.test(this.value)))) {
            issues.push({ severity: 'error', code: 'invalid', diagnostics: 'Invalid value in primitive type code', expression: [expression] });
        }
        return issues;
    }
    /**
