...
import { CompositionAttestationModeCodingType } from '../fhirValueSets/CompositionAttestationModeCodings.js';
import { CompositionAttestationModeCodeType } from '../fhirValueSets/CompositionAttestationModeCodes.js';
import { DocumentRelationshipTypeCodingType } from '../fhirValueSets/DocumentRelationshipTypeCodings.js';
...
import { CompositionStatusCodingType } from '../fhirValueSets/CompositionStatusCodings.js';
import { CompositionStatusCodeType } from '../fhirValueSets/CompositionStatusCodes.js';
import { DocTypecodesCodingType } from '../fhirValueSets/DocTypecodesCodings.js';
import { V3ConfidentialityClassificationCodingType } from '../fhirValueSets/V3ConfidentialityClassificationCodings.js';
/**
...
export declare class CompositionAttester extends fhir.BackboneElement {
     ...
     */
    static modeRequiredCoding(): CompositionAttestationModeCodingType;
    /**
...
export declare class CompositionRelatesTo extends fhir.BackboneElement {
     ...
     */
    static codeRequiredCoding(): DocumentRelationshipTypeCodingType;
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(): fhir.FtsIssue[];
...
export declare class Composition extends fhir.DomainResource {
     ...
     */
    static statusRequiredCoding(): CompositionStatusCodingType;
    /**
     * Preferred-bound Value Set for type (Composition.type)
     */
    static typePreferredCoding(): DocTypecodesCodingType;
    /**
     * Required-bound Value Set for confidentiality (Composition.confidentiality)
     */
    static confidentialityRequiredCoding(): V3ConfidentialityClassificationCodingType;
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(): fhir.FtsIssue[];
