...
import { ExtensionContextTypeCodingType } from '../fhirValueSets/ExtensionContextTypeCodings.js';
...
import { StructureDefinitionKindCodingType } from '../fhirValueSets/StructureDefinitionKindCodings.js';
...
import { TypeDerivationRuleCodingType } from '../fhirValueSets/TypeDerivationRuleCodings.js';
...
export declare class StructureDefinitionContext extends fhir.BackboneElement {
     ...
     */
    static typeRequiredCoding(): ExtensionContextTypeCodingType;
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(): fhir.OperationOutcome;
...
export declare class StructureDefinition extends fhir.DomainResource {
     ...
     */
    static keywordExtensibleCoding(): DefinitionUseCodingType;
    /**
     ...
     */
    static kindRequiredCoding(): StructureDefinitionKindCodingType;
    /**
     * Extensible-bound Value Set for type (StructureDefinition.type)
     */
    static typeExtensibleCoding(): DefinedTypesCodingType;
    /**
     * Required-bound Value Set for derivation (StructureDefinition.derivation)
     */
    static derivationRequiredCoding(): TypeDerivationRuleCodingType;
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(): fhir.OperationOutcome;
