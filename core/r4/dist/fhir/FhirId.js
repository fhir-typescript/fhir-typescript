    ...
    */
    ...
    doModelValidation(expression = '') {
        ...
        if ((this.value !== undefined) && (this.value !== null) && ((this.value === '') || (typeof this.value !== 'string') || (!FhirId._fts_regex.test(this.value)))) {
            issues.push({ severity: 'error', code: 'invalid', details: { text: 'Invalid value in primitive type id' }, expression: [expression] });
        }
        return issues;
    }
    /**
