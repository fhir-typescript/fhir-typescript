...
export class FhirString extends fhir.FhirPrimitive {
    ...
    */
    ...
    doModelValidation() {
        ...
        if ((this.value !== undefined) && ((this.value === '') || (typeof this.value !== 'string') || (!FhirString._fts_regex.test(this.value)))) {
