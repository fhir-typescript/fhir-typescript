...
import { CarePlanActivityKindCodingType } from '../fhirValueSets/CarePlanActivityKindCodings.js';
import { CarePlanActivityKindCodeType } from '../fhirValueSets/CarePlanActivityKindCodes.js';
import { CarePlanActivityStatusCodingType } from '../fhirValueSets/CarePlanActivityStatusCodings.js';
...
import { CarePlanIntentCodingType } from '../fhirValueSets/CarePlanIntentCodings.js';
...
export declare class CarePlanActivityDetail extends fhir.BackboneElement {
     ...
     */
    static kindRequiredCoding(): CarePlanActivityKindCodingType;
    /**
     * Required-bound Value Set for status (CarePlan.activity.detail.status)
     */
    static statusRequiredCoding(): CarePlanActivityStatusCodingType;
    /**
...
export declare class CarePlan extends fhir.DomainResource {
     ...
     */
    static intentRequiredCoding(): CarePlanIntentCodingType;
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(): fhir.FtsIssue[];
