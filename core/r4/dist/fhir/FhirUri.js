...
export class FhirUri extends fhir.FhirPrimitive {
    ...
    */
    ...
    doModelValidation() {
        ...
        if ((this.value !== undefined) && ((this.value === '') || (typeof this.value !== 'string') || (!FhirUri._fts_regex.test(this.value)))) {
