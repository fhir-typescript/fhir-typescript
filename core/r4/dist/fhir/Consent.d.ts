...
import { ConsentDataMeaningCodingType } from '../fhirValueSets/ConsentDataMeaningCodings.js';
import { ConsentDataMeaningCodeType } from '../fhirValueSets/ConsentDataMeaningCodes.js';
import { ConsentProvisionTypeCodingType } from '../fhirValueSets/ConsentProvisionTypeCodings.js';
...
import { ConsentStateCodesCodingType } from '../fhirValueSets/ConsentStateCodesCodings.js';
...
export declare class ConsentProvisionActor extends fhir.BackboneElement {
     ...
     */
    static roleExtensibleCoding(): SecurityRoleTypeCodingType;
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(): fhir.OperationOutcome;
...
export declare class ConsentProvisionData extends fhir.BackboneElement {
     ...
     */
    static meaningRequiredCoding(): ConsentDataMeaningCodingType;
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(): fhir.OperationOutcome;
...
export declare class ConsentProvision extends fhir.BackboneElement {
     ...
     */
    static typeRequiredCoding(): ConsentProvisionTypeCodingType;
    /**
     ...
     */
    static purposeExtensibleCoding(): V3PurposeOfUseCodingType;
    /**
     * Extensible-bound Value Set for class (Consent.provision.class)
     */
    static classExtensibleCoding(): ConsentContentClassCodingType;
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(): fhir.OperationOutcome;
...
export declare class Consent extends fhir.DomainResource {
     ...
     */
    static statusRequiredCoding(): ConsentStateCodesCodingType;
    /**
     * Extensible-bound Value Set for scope (Consent.scope)
     */
    static scopeExtensibleCoding(): ConsentScopeCodingType;
    /**
     * Extensible-bound Value Set for category (Consent.category)
     */
    static categoryExtensibleCoding(): ConsentCategoryCodingType;
    /**
     * Extensible-bound Value Set for policyRule (Consent.policyRule)
     */
    static policyRuleExtensibleCoding(): ConsentPolicyCodingType;
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(): fhir.OperationOutcome;
