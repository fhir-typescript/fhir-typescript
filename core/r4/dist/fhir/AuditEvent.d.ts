...
import { NetworkTypeCodingType } from '../fhirValueSets/NetworkTypeCodings.js';
...
import { AuditEventActionCodingType } from '../fhirValueSets/AuditEventActionCodings.js';
import { AuditEventOutcomeCodingType } from '../fhirValueSets/AuditEventOutcomeCodings.js';
/**
...
export declare class AuditEventAgentNetwork extends fhir.BackboneElement {
     ...
     */
    static typeRequiredCoding(): NetworkTypeCodingType;
    /**
...
export declare class AuditEventAgent extends fhir.BackboneElement {
     ...
     */
    static typeExtensibleCoding(): ParticipationRoleTypeCodingType;
    /**
     * Extensible-bound Value Set for media (AuditEvent.agent.media)
     */
    static mediaExtensibleCoding(): Dicm405MediatypeCodingType;
    /**
     * Extensible-bound Value Set for purposeOfUse (AuditEvent.agent.purposeOfUse)
     */
    static purposeOfUseExtensibleCoding(): V3PurposeOfUseCodingType;
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(): fhir.FtsIssue[];
...
export declare class AuditEventSource extends fhir.BackboneElement {
     ...
     */
    static typeExtensibleCoding(): AuditSourceTypeCodingType;
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(): fhir.FtsIssue[];
...
export declare class AuditEventEntity extends fhir.BackboneElement {
     ...
     */
    static typeExtensibleCoding(): AuditEntityTypeCodingType;
    /**
     * Extensible-bound Value Set for role (AuditEvent.entity.role)
     */
    static roleExtensibleCoding(): ObjectRoleCodingType;
    /**
     * Extensible-bound Value Set for securityLabel (AuditEvent.entity.securityLabel)
     */
    static securityLabelExtensibleCoding(): SecurityLabelsCodingType;
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(): fhir.FtsIssue[];
...
export declare class AuditEvent extends fhir.DomainResource {
     ...
     */
    static typeExtensibleCoding(): AuditEventTypeCodingType;
    /**
     * Extensible-bound Value Set for subtype (AuditEvent.subtype)
     */
    static subtypeExtensibleCoding(): AuditEventSubTypeCodingType;
    /**
     * Required-bound Value Set for action (AuditEvent.action)
     */
    static actionRequiredCoding(): AuditEventActionCodingType;
    /**
     * Required-bound Value Set for outcome (AuditEvent.outcome)
     */
    static outcomeRequiredCoding(): AuditEventOutcomeCodingType;
    /**
     * Extensible-bound Value Set for purposeOfEvent (AuditEvent.purposeOfEvent)
     */
    static purposeOfEventExtensibleCoding(): V3PurposeOfUseCodingType;
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(): fhir.FtsIssue[];
