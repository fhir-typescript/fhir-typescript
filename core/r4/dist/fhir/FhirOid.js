...
export class FhirOid extends fhir.FhirPrimitive {
    ...
    */
    ...
    doModelValidation() {
        ...
        if ((this.value !== undefined) && ((this.value === '') || (typeof this.value !== 'string') || (!FhirOid._fts_regex.test(this.value)))) {
