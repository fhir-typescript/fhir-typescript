 ...
 */
export declare const ConsentContentClassCodes: {
    /**
     ...
     */
    readonly CDADocuments: "application/hl7-cda+xml";
    /**
     ...
     */
    readonly LipidLabReport: "http://hl7.org/fhir/StructureDefinition/lipidprofile";
    /**
 ...
 * This value set includes the FHIR resource types, along with some other important content class codes
 */
export declare type ConsentContentClassCodeType = typeof ConsentContentClassCodes[keyof typeof ConsentContentClassCodes];
//# sourceMappingURL=ConsentContentClassCodes.d.ts.map