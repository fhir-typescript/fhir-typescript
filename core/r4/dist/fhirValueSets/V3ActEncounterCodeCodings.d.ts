 ...
 */
export declare const V3ActEncounterCodeCodings: {
    /**
 ...
 *  Domain provides codes that qualify the ActEncounterClass (ENC)
 */
export declare type V3ActEncounterCodeCodingType = typeof V3ActEncounterCodeCodings;
//# sourceMappingURL=V3ActEncounterCodeCodings.d.ts.map