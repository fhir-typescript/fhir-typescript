 ...
 */
export declare const ProvenanceAgentRoleCodes: {
    /**
 ...
 * The role that a provenance participant played
 */
export declare type ProvenanceAgentRoleCodeType = typeof ProvenanceAgentRoleCodes[keyof typeof ProvenanceAgentRoleCodes];
//# sourceMappingURL=ProvenanceAgentRoleCodes.d.ts.map