 ...
 */
export declare type ContractPublicationstatusCodingType = {
    /**
     ...
     */
    Terminated: CodingArgs;
};
/**
 * This value set contract specific codes for status.
 */
export declare const ContractPublicationstatusCodings: ContractPublicationstatusCodingType;
//# sourceMappingURL=ContractPublicationstatusCodings.d.ts.map