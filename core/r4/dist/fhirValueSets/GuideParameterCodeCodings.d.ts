 ...
 */
export declare const GuideParameterCodeCodings: {
    /**
 ...
 * Code of parameter that is input to the guide.
 */
export declare type GuideParameterCodeCodingType = typeof GuideParameterCodeCodings;
//# sourceMappingURL=GuideParameterCodeCodings.d.ts.map