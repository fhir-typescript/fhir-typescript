 ...
 */
export declare const AssertOperatorCodesCodes: {
    /**
 ...
 * The type of operator to use for assertion.
 */
export declare type AssertOperatorCodesCodeType = typeof AssertOperatorCodesCodes[keyof typeof AssertOperatorCodesCodes];
//# sourceMappingURL=AssertOperatorCodesCodes.d.ts.map