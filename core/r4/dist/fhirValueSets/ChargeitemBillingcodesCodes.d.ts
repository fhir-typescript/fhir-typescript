 ...
 */
export declare const ChargeitemBillingcodesCodes: {
    /**
 ...
 * Example set of codes that can be used for billing purposes.
 */
export declare type ChargeitemBillingcodesCodeType = typeof ChargeitemBillingcodesCodes[keyof typeof ChargeitemBillingcodesCodes];
//# sourceMappingURL=ChargeitemBillingcodesCodes.d.ts.map