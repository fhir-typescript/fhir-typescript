 ...
 */
export declare const GuideParameterCodeCodes: {
    /**
 ...
 * Code of parameter that is input to the guide.
 */
export declare type GuideParameterCodeCodeType = typeof GuideParameterCodeCodes[keyof typeof GuideParameterCodeCodes];
//# sourceMappingURL=GuideParameterCodeCodes.d.ts.map