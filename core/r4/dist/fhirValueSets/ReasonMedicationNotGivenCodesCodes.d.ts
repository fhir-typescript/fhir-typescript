 ...
 */
export declare const ReasonMedicationNotGivenCodesCodes: {
    /**
     * Code: 182896008
     */
 ...
 * This value set includes all medication refused, medication not administered, and non-administration of necessary drug or medicine codes from SNOMED CT - provided as an exemplar value set.
 */
export declare type ReasonMedicationNotGivenCodesCodeType = typeof ReasonMedicationNotGivenCodesCodes[keyof typeof ReasonMedicationNotGivenCodesCodes];
//# sourceMappingURL=ReasonMedicationNotGivenCodesCodes.d.ts.map