 ...
 */
export declare const ContractStatusCodes: {
    /**
 ...
 * This value set contract specific codes for status.
 */
export declare type ContractStatusCodeType = typeof ContractStatusCodes[keyof typeof ContractStatusCodes];
//# sourceMappingURL=ContractStatusCodes.d.ts.map