 ...
 */
export declare const ListExampleCodesCodes: {
    /**
 ...
 * Example use codes for the List resource - typical kinds of use.
 */
export declare type ListExampleCodesCodeType = typeof ListExampleCodesCodes[keyof typeof ListExampleCodesCodes];
//# sourceMappingURL=ListExampleCodesCodes.d.ts.map