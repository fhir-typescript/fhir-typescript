 ...
 */
export declare const V3ActEncounterCodeCodes: {
    /**
 ...
 *  Domain provides codes that qualify the ActEncounterClass (ENC)
 */
export declare type V3ActEncounterCodeCodeType = typeof V3ActEncounterCodeCodes[keyof typeof V3ActEncounterCodeCodes];
//# sourceMappingURL=V3ActEncounterCodeCodes.d.ts.map