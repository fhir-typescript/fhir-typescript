 ...
 */
export declare type ServicePlaceCodingType = {
    /**
 ...
 * This value set includes a smattering of Service Place codes.
 */
export declare const ServicePlaceCodings: ServicePlaceCodingType;
//# sourceMappingURL=ServicePlaceCodings.d.ts.map