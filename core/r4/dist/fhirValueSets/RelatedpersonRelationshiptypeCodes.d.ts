 ...
 */
export declare const RelatedpersonRelationshiptypeCodes: {
    /**
     * _PersonalRelationshipRoleType: PersonalRelationshipRoleType
     */
    readonly PersonalRelationshipRoleType: "_PersonalRelationshipRoleType";
    /**
 ...
 * A set of codes that can be used to indicate the relationship between a Patient and a Related Person.
 */
export declare type RelatedpersonRelationshiptypeCodeType = typeof RelatedpersonRelationshiptypeCodes[keyof typeof RelatedpersonRelationshiptypeCodes];
//# sourceMappingURL=RelatedpersonRelationshiptypeCodes.d.ts.map