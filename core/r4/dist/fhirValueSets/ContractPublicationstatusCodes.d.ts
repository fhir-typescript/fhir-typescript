 ...
 */
export declare const ContractPublicationstatusCodes: {
    /**
 ...
 * This value set contract specific codes for status.
 */
export declare type ContractPublicationstatusCodeType = typeof ContractPublicationstatusCodes[keyof typeof ContractPublicationstatusCodes];
//# sourceMappingURL=ContractPublicationstatusCodes.d.ts.map