 ...
 */
export declare const CurrenciesCodes: {
    /**
     * Code: AED
     */
 ...
 * Currency codes from ISO 4217 (see https://www.iso.org/iso-4217-currency-codes.html)
 */
export declare type CurrenciesCodeType = typeof CurrenciesCodes[keyof typeof CurrenciesCodes];
//# sourceMappingURL=CurrenciesCodes.d.ts.map