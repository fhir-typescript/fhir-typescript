 ...
 */
export declare const FHIRVersionCodes: {
    /**
 ...
 * All published FHIR Versions.
 */
export declare type FHIRVersionCodeType = typeof FHIRVersionCodes[keyof typeof FHIRVersionCodes];
//# sourceMappingURL=FHIRVersionCodes.d.ts.map