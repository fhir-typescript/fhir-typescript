 ...
 */
export declare const TestscriptOperationCodesCodes: {
    /**
 ...
 * This value set defines a set of codes that are used to indicate the supported operations of a testing engine or tool.
 */
export declare type TestscriptOperationCodesCodeType = typeof TestscriptOperationCodesCodes[keyof typeof TestscriptOperationCodesCodes];
//# sourceMappingURL=TestscriptOperationCodesCodes.d.ts.map