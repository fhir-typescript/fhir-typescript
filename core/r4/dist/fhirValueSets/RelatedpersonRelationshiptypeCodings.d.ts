 ...
 */
export declare const RelatedpersonRelationshiptypeCodings: {
    /**
 ...
 * A set of codes that can be used to indicate the relationship between a Patient and a Related Person.
 */
export declare type RelatedpersonRelationshiptypeCodingType = typeof RelatedpersonRelationshiptypeCodings;
