...
export class Condition extends fhir.DomainResource {
  ...
  constructor(source:Partial<ConditionArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['dateRecorded'] !== undefined) { this.dateRecorded = new fhir.FhirDate({value: source.dateRecorded}, options); }
    if (source['_dateRecorded']) {
      if (this.dateRecorded) { this.dateRecorded.addExtendedProperties(source._dateRecorded!); }
      else { this.dateRecorded = new fhir.FhirDate(source._dateRecorded as Partial<fhir.FhirDateArgs>, options); }
    }
    if (source['code']) { this.code = new fhir.CodeableConcept(source.code, options); }
    else { this.code = null; }
    if (source['category']) { this.category = new fhir.CodeableConcept(source.category, options); }
    if (source['clinicalStatus'] !== undefined) { this.clinicalStatus = new fhir.FhirCode({value: source.clinicalStatus}, options); }
    if (source['_clinicalStatus']) {
      if (this.clinicalStatus) { this.clinicalStatus.addExtendedProperties(source._clinicalStatus!); }
      else { this.clinicalStatus = new fhir.FhirCode(source._clinicalStatus as Partial<fhir.FhirCodeArgs>, options); }
    }
    ...
    else if (source['abatementQuantity']) { this.abatement = new fhir.Quantity(source.abatementQuantity, options); }
