...
export class ValueSetCodeSystemConcept extends fhir.BackboneElement {
  ...
  constructor(source:Partial<ValueSetCodeSystemConceptArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['definition'] !== undefined) { this.definition = new fhir.FhirString({value: source.definition}, options); }
    if (source['_definition']) {
      if (this.definition) { this.definition.addExtendedProperties(source._definition!); }
      else { this.definition = new fhir.FhirString(source._definition as Partial<fhir.FhirStringArgs>, options); }
    }
    if (source['designation']) { this.designation = source.designation.map((x) => new fhir.ValueSetCodeSystemConceptDesignation(x, options)); }
    else { this.designation = []; }
    if (source['concept']) { this.concept = source.concept.map((x) => new fhir.ValueSetCodeSystemConcept(x, options)); }
    else { this.concept = []; }
  }
  /**
   * Function to perform basic model validation (e.g., check if required elements are present).
...
export class ValueSetCodeSystem extends fhir.BackboneElement {
  ...
  constructor(source:Partial<ValueSetCodeSystemArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['caseSensitive'] !== undefined) { this.caseSensitive = new fhir.FhirBoolean({value: source.caseSensitive}, options); }
    if (source['_caseSensitive']) {
      if (this.caseSensitive) { this.caseSensitive.addExtendedProperties(source._caseSensitive!); }
      else { this.caseSensitive = new fhir.FhirBoolean(source._caseSensitive as Partial<fhir.FhirBooleanArgs>, options); }
    }
    if (source['concept']) { this.concept = source.concept.map((x) => new fhir.ValueSetCodeSystemConcept(x, options)); }
    else { this.concept = []; }
  }
...
export class ValueSet extends fhir.DomainResource {
  ...
  constructor(source:Partial<ValueSetArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['contact']) { this.contact = source.contact.map((x) => new fhir.ValueSetContact(x, options)); }
    else { this.contact = []; }
    ...
    if (source['codeSystem']) { this.codeSystem = new fhir.ValueSetCodeSystem(source.codeSystem, options); }
