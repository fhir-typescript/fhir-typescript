...
export class FhirInstant extends fhir.FhirPrimitive {
   ...
   */
  public static override readonly _fts_dataType:string = 'Instant';
  /**
  ...
  */
  ...
  public override doModelValidation(exp:string = ''):fhir.FtsIssue[] {
    ...
    if ((this.value !== undefined) && (this.value !== null) && ((this.value === '') || (typeof this.value !== 'string') || (!FhirInstant._fts_regex.test(this.value)))) {
      issues.push({ severity: 'error', code: 'invalid', details: { text: 'Invalid value in primitive type instant' }, expression: [exp]});
    }
    return issues;
  }
}
