 ...
 */
export declare type DigitalMediaTypeCodingType = {
    /**
 ...
 * Whether the Media is a photo, video, or audio
 */
export declare const DigitalMediaTypeCodings: DigitalMediaTypeCodingType;
//# sourceMappingURL=DigitalMediaTypeCodings.d.ts.map