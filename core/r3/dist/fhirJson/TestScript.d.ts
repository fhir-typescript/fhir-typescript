 ...
 */
export interface TestScriptRuleParam extends fhir.BackboneElement {
    /**
 ...
 */
export interface TestScriptRule extends fhir.BackboneElement {
    /**
     ...
     * The parameter value can be dynamic at runtime.
     */
    param?: (fhir.TestScriptRuleParam | null)[] | undefined;
}
/**
 * The parameter value can be dynamic at runtime.
 */
export interface TestScriptRulesetRuleParam extends fhir.BackboneElement {
    /**
     * The external rule template would be looking for the parameter by this name.
     */
    name: string | null;
 ...
 */
export interface TestScriptRulesetRule extends fhir.BackboneElement {
    /**
     ...
     */
    _ruleId?: fhir.FhirElement;
    /**
     * The parameter value can be dynamic at runtime.
     */
    param?: (fhir.TestScriptRulesetRuleParam | null)[] | undefined;
}
/**
 ...
 */
export interface TestScriptRuleset extends fhir.BackboneElement {
    /**
     ...
     * This qualifies each param name so that  a parameter with the same name can be used differently by the different rules with the ruleset.
     */
    rule: (fhir.TestScriptRulesetRule | null)[] | null;
}
/**
...
export interface TestScriptSetupActionOperation extends fhir.BackboneElement {
     ...
     */
    accept?: 'json' | 'none' | 'ttl' | 'xml' | undefined;
    /**
     ...
     */
    contentType?: 'json' | 'none' | 'ttl' | 'xml' | undefined;
    /**
 ...
 * The parameter value can be dynamic at runtime.
 */
export interface TestScriptSetupActionAssertRuleParam extends fhir.BackboneElement {
    /**
     * The external rule template would be looking for the parameter by this name.
     */
    name: string | null;
 ...
 */
export interface TestScriptSetupActionAssertRule extends fhir.BackboneElement {
    /**
     ...
     * The parameter value can be dynamic at runtime.
     */
    param?: (fhir.TestScriptSetupActionAssertRuleParam | null)[] | undefined;
}
/**
 * The parameter value can be dynamic at runtime.
 */
export interface TestScriptSetupActionAssertRulesetRuleParam extends fhir.BackboneElement {
    /**
     * The external rule template would be looking for the parameter by this name.
     */
    name: string | null;
 ...
 * This qualifies each param name so that  a parameter with the same name can be used differently by the different rules with the ruleset.
 */
export interface TestScriptSetupActionAssertRulesetRule extends fhir.BackboneElement {
    /**
     * Id of the referenced rule within the external ruleset template.
     */
    ruleId: string | null;
     ...
     * The parameter value can be dynamic at runtime.
     */
    param?: (fhir.TestScriptSetupActionAssertRulesetRuleParam | null)[] | undefined;
}
/**
 ...
 */
export interface TestScriptSetupActionAssertRuleset extends fhir.BackboneElement {
    /**
     ...
     */
    _rulesetId?: fhir.FhirElement;
    /**
     * This qualifies each param name so that  a parameter with the same name can be used differently by the different rules with the ruleset.
     */
    rule?: (fhir.TestScriptSetupActionAssertRulesetRule | null)[] | undefined;
}
/**
...
export interface TestScript extends fhir.DomainResource {
     ...
     * Each rule should be treated by test engines as one assertion regardless of how many assertions are contained within the external rule template.  The impact of negative rule evaluation on test script execution is the same as an assertion failure which is described elsewhere in the TestScript resource.
     */
    rule?: (fhir.TestScriptRule | null)[] | undefined;
    /**
     * Each rule within a ruleset should be treated by test engines as one assertion regardless of how many assertions are contained within the external rule template.  The impact of negative rule evaluation on test script execution is the same as an assertion failure which is described elsewhere in the TestScript resource.
     */
    ruleset?: (fhir.TestScriptRuleset | null)[] | undefined;
    /**
     * A series of required setup operations before tests are executed.
     */
