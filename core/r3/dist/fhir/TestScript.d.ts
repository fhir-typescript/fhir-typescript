...
export interface TestScriptMetadataCapabilityArgs extends fhir.BackboneElementArgs {
     ...
     */
    capabilities: fhir.ReferenceArgs | null;
}
/**
...
export declare class TestScriptMetadataCapability extends fhir.BackboneElement {
     ...
     * The conformance statement of the server has to contain at a minimum the contents of the reference pointed to by this element.
     */
    capabilities: fhir.Reference | null;
    /**
...
/**
 * Valid arguments for the TestScriptRuleParam type.
 */
export interface TestScriptRuleParamArgs extends fhir.BackboneElementArgs {
    /**
     * The external rule template would be looking for the parameter by this name.
     */
    name: fhir.FhirString | string | undefined;
    /**
     * Extended properties for primitive element: TestScript.rule.param.name
     */
    _name?: fhir.FhirElementArgs;
    /**
    ...
    /**
     * Extended properties for primitive element: TestScript.rule.param.value
     */
 ...
 */
export declare class TestScriptRuleParam extends fhir.BackboneElement {
    /**
     * Mapping of this datatype to a FHIR equivalent
     */
    static readonly _fts_dataType: string;
     ...
     */
    constructor(source?: Partial<TestScriptRuleParamArgs>, options?: fhir.FhirConstructorOptions);
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(exp?: string): fhir.FtsIssue[];
...
/**
 * Valid arguments for the TestScriptRule type.
 */
export interface TestScriptRuleArgs extends fhir.BackboneElementArgs {
    /**
     ...
     * The parameter value can be dynamic at runtime.
     */
    param?: fhir.TestScriptRuleParamArgs[] | undefined;
}
/**
 ...
 */
export declare class TestScriptRule extends fhir.BackboneElement {
    /**
     * Mapping of this datatype to a FHIR equivalent
     */
    static readonly _fts_dataType: string;
     ...
     * The parameter value can be dynamic at runtime.
     */
    param: fhir.TestScriptRuleParam[];
    /**
     * Default constructor for TestScriptRule - initializes any required elements to null if a value is not provided.
     */
    constructor(source?: Partial<TestScriptRuleArgs>, options?: fhir.FhirConstructorOptions);
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(exp?: string): fhir.FtsIssue[];
...
/**
 * Valid arguments for the TestScriptRulesetRuleParam type.
 */
export interface TestScriptRulesetRuleParamArgs extends fhir.BackboneElementArgs {
    /**
     * The external rule template would be looking for the parameter by this name.
     */
    name: fhir.FhirString | string | undefined;
    /**
     * Extended properties for primitive element: TestScript.ruleset.rule.param.name
     */
    _name?: fhir.FhirElementArgs;
    /**
    ...
    value?: fhir.FhirString | string | undefined;
    /**
     * Extended properties for primitive element: TestScript.ruleset.rule.param.value
     */
    _value?: fhir.FhirElementArgs;
}
/**
 * The parameter value can be dynamic at runtime.
 */
export declare class TestScriptRulesetRuleParam extends fhir.BackboneElement {
    /**
     * Mapping of this datatype to a FHIR equivalent
     */
    static readonly _fts_dataType: string;
     ...
     */
    constructor(source?: Partial<TestScriptRulesetRuleParamArgs>, options?: fhir.FhirConstructorOptions);
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(exp?: string): fhir.FtsIssue[];
...
/**
 * Valid arguments for the TestScriptRulesetRule type.
 */
export interface TestScriptRulesetRuleArgs extends fhir.BackboneElementArgs {
    /**
     * Id of the referenced rule within the external ruleset template.
     */
    ruleId: fhir.FhirId | string | undefined;
    /**
     * Extended properties for primitive element: TestScript.ruleset.rule.ruleId
     */
    _ruleId?: fhir.FhirElementArgs;
    /**
     * The parameter value can be dynamic at runtime.
     */
    param?: fhir.TestScriptRulesetRuleParamArgs[] | undefined;
}
/**
 ...
 */
export declare class TestScriptRulesetRule extends fhir.BackboneElement {
    /**
     * Mapping of this datatype to a FHIR equivalent
     */
    static readonly _fts_dataType: string;
     ...
     * Id of the referenced rule within the external ruleset template.
     */
    ruleId: fhir.FhirId | null;
    /**
     * The parameter value can be dynamic at runtime.
     */
    param: fhir.TestScriptRulesetRuleParam[];
    /**
     * Default constructor for TestScriptRulesetRule - initializes any required elements to null if a value is not provided.
     */
    constructor(source?: Partial<TestScriptRulesetRuleArgs>, options?: fhir.FhirConstructorOptions);
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(exp?: string): fhir.FtsIssue[];
...
/**
 * Valid arguments for the TestScriptRuleset type.
 */
export interface TestScriptRulesetArgs extends fhir.BackboneElementArgs {
    /**
     ...
     * This qualifies each param name so that  a parameter with the same name can be used differently by the different rules with the ruleset.
     */
    rule: fhir.TestScriptRulesetRuleArgs[] | null;
}
/**
 ...
 */
export declare class TestScriptRuleset extends fhir.BackboneElement {
    /**
     * Mapping of this datatype to a FHIR equivalent
     */
    static readonly _fts_dataType: string;
     ...
     * This qualifies each param name so that  a parameter with the same name can be used differently by the different rules with the ruleset.
     */
    rule: fhir.TestScriptRulesetRule[];
    /**
     * Default constructor for TestScriptRuleset - initializes any required elements to null if a value is not provided.
     */
    constructor(source?: Partial<TestScriptRulesetArgs>, options?: fhir.FhirConstructorOptions);
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(exp?: string): fhir.FtsIssue[];
...
/**
 * Valid arguments for the TestScriptSetupActionAssertRuleParam type.
 */
export interface TestScriptSetupActionAssertRuleParamArgs extends fhir.BackboneElementArgs {
    /**
     * The external rule template would be looking for the parameter by this name.
     */
    name: fhir.FhirString | string | undefined;
    /**
     * Extended properties for primitive element: TestScript.setup.action.assert.rule.param.name
     */
    _name?: fhir.FhirElementArgs;
    /**
    ...
    value: fhir.FhirString | string | undefined;
    /**
     * Extended properties for primitive element: TestScript.setup.action.assert.rule.param.value
     */
    _value?: fhir.FhirElementArgs;
}
/**
 * The parameter value can be dynamic at runtime.
 */
export declare class TestScriptSetupActionAssertRuleParam extends fhir.BackboneElement {
    /**
     * Mapping of this datatype to a FHIR equivalent
     */
    static readonly _fts_dataType: string;
     ...
     */
    constructor(source?: Partial<TestScriptSetupActionAssertRuleParamArgs>, options?: fhir.FhirConstructorOptions);
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(exp?: string): fhir.FtsIssue[];
...
/**
 * Valid arguments for the TestScriptSetupActionAssertRule type.
 */
export interface TestScriptSetupActionAssertRuleArgs extends fhir.BackboneElementArgs {
    /**
     * The TestScript.rule id value this assert will evaluate.
     */
    ruleId: fhir.FhirId | string | undefined;
    /**
     * Extended properties for primitive element: TestScript.setup.action.assert.rule.ruleId
     */
    _ruleId?: fhir.FhirElementArgs;
    /**
     * The parameter value can be dynamic at runtime.
     */
    param?: fhir.TestScriptSetupActionAssertRuleParamArgs[] | undefined;
}
/**
 ...
 */
export declare class TestScriptSetupActionAssertRule extends fhir.BackboneElement {
    /**
     * Mapping of this datatype to a FHIR equivalent
     */
    static readonly _fts_dataType: string;
     ...
     * The parameter value can be dynamic at runtime.
     */
    param: fhir.TestScriptSetupActionAssertRuleParam[];
    /**
     ...
     */
    constructor(source?: Partial<TestScriptSetupActionAssertRuleArgs>, options?: fhir.FhirConstructorOptions);
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(exp?: string): fhir.FtsIssue[];
...
/**
 * Valid arguments for the TestScriptSetupActionAssertRulesetRuleParam type.
 */
export interface TestScriptSetupActionAssertRulesetRuleParamArgs extends fhir.BackboneElementArgs {
    /**
     * The external rule template would be looking for the parameter by this name.
     */
    name: fhir.FhirString | string | undefined;
    /**
     * Extended properties for primitive element: TestScript.setup.action.assert.ruleset.rule.param.name
     */
    _name?: fhir.FhirElementArgs;
    /**
    ...
    value: fhir.FhirString | string | undefined;
    /**
     * Extended properties for primitive element: TestScript.setup.action.assert.ruleset.rule.param.value
     */
    _value?: fhir.FhirElementArgs;
}
/**
 * The parameter value can be dynamic at runtime.
 */
export declare class TestScriptSetupActionAssertRulesetRuleParam extends fhir.BackboneElement {
    /**
     * Mapping of this datatype to a FHIR equivalent
     */
    static readonly _fts_dataType: string;
     ...
     */
    constructor(source?: Partial<TestScriptSetupActionAssertRulesetRuleParamArgs>, options?: fhir.FhirConstructorOptions);
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(exp?: string): fhir.FtsIssue[];
...
/**
 * Valid arguments for the TestScriptSetupActionAssertRulesetRule type.
 */
export interface TestScriptSetupActionAssertRulesetRuleArgs extends fhir.BackboneElementArgs {
    /**
     * Id of the referenced rule within the external ruleset template.
     */
    ruleId: fhir.FhirId | string | undefined;
    /**
     * Extended properties for primitive element: TestScript.setup.action.assert.ruleset.rule.ruleId
     */
    _ruleId?: fhir.FhirElementArgs;
    /**
     * The parameter value can be dynamic at runtime.
     */
    param?: fhir.TestScriptSetupActionAssertRulesetRuleParamArgs[] | undefined;
}
/**
 * This qualifies each param name so that  a parameter with the same name can be used differently by the different rules with the ruleset.
 */
export declare class TestScriptSetupActionAssertRulesetRule extends fhir.BackboneElement {
    /**
     * Mapping of this datatype to a FHIR equivalent
     */
    static readonly _fts_dataType: string;
     ...
     * The parameter value can be dynamic at runtime.
     */
    param: fhir.TestScriptSetupActionAssertRulesetRuleParam[];
    /**
     ...
     */
    constructor(source?: Partial<TestScriptSetupActionAssertRulesetRuleArgs>, options?: fhir.FhirConstructorOptions);
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(exp?: string): fhir.FtsIssue[];
...
/**
 * Valid arguments for the TestScriptSetupActionAssertRuleset type.
 */
export interface TestScriptSetupActionAssertRulesetArgs extends fhir.BackboneElementArgs {
    /**
     * The TestScript.ruleset id value this assert will evaluate.
     */
    rulesetId: fhir.FhirId | string | undefined;
    /**
     * Extended properties for primitive element: TestScript.setup.action.assert.ruleset.rulesetId
     */
    _rulesetId?: fhir.FhirElementArgs;
    /**
     * This qualifies each param name so that  a parameter with the same name can be used differently by the different rules with the ruleset.
     */
    rule?: fhir.TestScriptSetupActionAssertRulesetRuleArgs[] | undefined;
}
/**
 ...
 */
export declare class TestScriptSetupActionAssertRuleset extends fhir.BackboneElement {
    /**
     * Mapping of this datatype to a FHIR equivalent
     */
    static readonly _fts_dataType: string;
     ...
     * The TestScript.ruleset id value this assert will evaluate.
     */
    rulesetId: fhir.FhirId | null;
    /**
     * This qualifies each param name so that  a parameter with the same name can be used differently by the different rules with the ruleset.
     */
    rule: fhir.TestScriptSetupActionAssertRulesetRule[];
    /**
     ...
     */
    constructor(source?: Partial<TestScriptSetupActionAssertRulesetArgs>, options?: fhir.FhirConstructorOptions);
    /**
     * Function to perform basic model validation (e.g., check if required elements are present).
     */
    doModelValidation(exp?: string): fhir.FtsIssue[];
...
export interface TestScriptSetupActionAssertArgs extends fhir.BackboneElementArgs {
     ...
     * Each rule should get evaluated by test engines as one assertion regardless of how many assertions are contained within the external rule template.  The impact of negative rule evaluation on test script execution is the same as an assertion failure which is descibed elsewhere in the TestScript resource.
     */
    rule?: fhir.TestScriptSetupActionAssertRuleArgs | undefined;
    /**
     * Each rule within a ruleset should get evaluated by test engines as a separate assertion.  The impact of negative rule evaluation on test script execution is the same as an assertion failure which is descibed elsewhere in the TestScript resource.  If the first rule within the ruleset results in a failed assertion, then test engines do not have to evaluate the rest of the rules within the ruleset.
     */
    ruleset?: fhir.TestScriptSetupActionAssertRulesetArgs | undefined;
    /**
     * This can be a statically defined fixture (at the top of the testscript) or a dynamically set fixture created by responseId of the action.operation element.
     */
    sourceId?: fhir.FhirId | string | undefined;
...
export declare class TestScriptSetupActionAssert extends fhir.BackboneElement {
     ...
     * Each rule should get evaluated by test engines as one assertion regardless of how many assertions are contained within the external rule template.  The impact of negative rule evaluation on test script execution is the same as an assertion failure which is descibed elsewhere in the TestScript resource.
     */
    rule?: fhir.TestScriptSetupActionAssertRule | undefined;
    /**
     * Each rule within a ruleset should get evaluated by test engines as a separate assertion.  The impact of negative rule evaluation on test script execution is the same as an assertion failure which is descibed elsewhere in the TestScript resource.  If the first rule within the ruleset results in a failed assertion, then test engines do not have to evaluate the rest of the rules within the ruleset.
     */
    ruleset?: fhir.TestScriptSetupActionAssertRuleset | undefined;
    /**
     * This can be a statically defined fixture (at the top of the testscript) or a dynamically set fixture created by responseId of the action.operation element.
     */
    sourceId?: fhir.FhirId | undefined;
...
export interface TestScriptArgs extends fhir.DomainResourceArgs {
     ...
     * Each rule should be treated by test engines as one assertion regardless of how many assertions are contained within the external rule template.  The impact of negative rule evaluation on test script execution is the same as an assertion failure which is described elsewhere in the TestScript resource.
     */
    rule?: fhir.TestScriptRuleArgs[] | undefined;
    /**
     * Each rule within a ruleset should be treated by test engines as one assertion regardless of how many assertions are contained within the external rule template.  The impact of negative rule evaluation on test script execution is the same as an assertion failure which is described elsewhere in the TestScript resource.
     */
    ruleset?: fhir.TestScriptRulesetArgs[] | undefined;
    /**
     * A series of required setup operations before tests are executed.
     */
...
export declare class TestScript extends fhir.DomainResource {
     ...
     * Each rule should be treated by test engines as one assertion regardless of how many assertions are contained within the external rule template.  The impact of negative rule evaluation on test script execution is the same as an assertion failure which is described elsewhere in the TestScript resource.
     */
    rule: fhir.TestScriptRule[];
    /**
     * Each rule within a ruleset should be treated by test engines as one assertion regardless of how many assertions are contained within the external rule template.  The impact of negative rule evaluation on test script execution is the same as an assertion failure which is described elsewhere in the TestScript resource.
     */
    ruleset: fhir.TestScriptRuleset[];
    /**
     * A series of required setup operations before tests are executed.
     */
