...
export interface MeasureGroupPopulationArgs extends fhir.BackboneElementArgs {
    ...
    /**
     * Extended properties for primitive element: Measure.group.population.name
     */
    ...
    /**
     * Extended properties for primitive element: Measure.group.population.criteria
     */
...
export interface MeasureGroupStratifierArgs extends fhir.BackboneElementArgs {
    ...
    criteria?: fhir.FhirString | string | undefined;
    /**
     * Extended properties for primitive element: Measure.group.stratifier.criteria
     */
    _criteria?: fhir.FhirElementArgs;
    /**
    ...
    /**
     * Extended properties for primitive element: Measure.group.stratifier.path
     */
...
export declare class MeasureGroupStratifier extends fhir.BackboneElement {
     ...
     * The criteria for the stratifier. This must be the name of an expression defined within a referenced library.
     */
    criteria?: fhir.FhirString | undefined;
    /**
     * The path to an element that defines the stratifier, specified as a valid FHIR resource path.
     */
...
export interface MeasureGroupArgs extends fhir.BackboneElementArgs {
    ...
    name?: fhir.FhirString | string | undefined;
    /**
     * Extended properties for primitive element: Measure.group.name
     */
    _name?: fhir.FhirElementArgs;
    /**
...
export interface MeasureSupplementalDataArgs extends fhir.BackboneElementArgs {
    ...
    criteria?: fhir.FhirString | string | undefined;
    /**
     * Extended properties for primitive element: Measure.supplementalData.criteria
     */
    _criteria?: fhir.FhirElementArgs;
    /**
    ...
    path?: fhir.FhirString | string | undefined;
    /**
     * Extended properties for primitive element: Measure.supplementalData.path
     */
    _path?: fhir.FhirElementArgs;
}
/**
...
export interface MeasureArgs extends fhir.DomainResourceArgs {
     ...
     */
    improvementNotation?: fhir.FhirString | string | undefined;
    /**
     * Extended properties for primitive element: Measure.improvementNotation
     */
    _improvementNotation?: fhir.FhirElementArgs;
    /**
     ...
     */
    set?: fhir.FhirString | string | undefined;
    /**
     * Extended properties for primitive element: Measure.set
     */
    _set?: fhir.FhirElementArgs;
    /**
     * A group of population criteria for the measure.
     */
...
export declare class Measure extends fhir.DomainResource {
     ...
     * Information on whether an increase or decrease in score is the preferred result (e.g., a higher score indicates better quality OR a lower score indicates better quality OR quality is whthin a range).
     */
    improvementNotation?: fhir.FhirString | undefined;
    /**
     * Provides a description of an individual term used within the measure.
     */
