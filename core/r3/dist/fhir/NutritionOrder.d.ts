...
import { NutritionRequestStatusCodeType } from '../fhirValueSets/NutritionRequestStatusCodes.js';
/**
...
export interface NutritionOrderArgs extends fhir.DomainResourceArgs {
     ...
     */
    status?: fhir.FhirCode<NutritionRequestStatusCodeType> | string | undefined;
    /**
...
export declare class NutritionOrder extends fhir.DomainResource {
     ...
     * This element is labeled as a modifier because the status contains codes that mark the resource as not currently valid.
     */
    status?: fhir.FhirCode<NutritionRequestStatusCodeType> | undefined;
    /**
     * The person (patient) who needs the nutrition order for an oral diet, nutritional supplement and/or enteral or formula feeding.
     */
