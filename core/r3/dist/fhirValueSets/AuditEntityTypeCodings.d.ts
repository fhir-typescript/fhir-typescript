 ...
 */
export declare type AuditEntityTypeCodingType = {
    /**
     * 1: Person
     */
    Person: CodingArgs;
 ...
 * Code for the entity type involved in the audit event.
 */
export declare const AuditEntityTypeCodings: AuditEntityTypeCodingType;
//# sourceMappingURL=AuditEntityTypeCodings.d.ts.map