 ...
 */
export declare type ContractStatusCodingType = {
    /**
 ...
 * This value set contract specific codes for status.
 */
export declare const ContractStatusCodings: ContractStatusCodingType;
//# sourceMappingURL=ContractStatusCodings.d.ts.map