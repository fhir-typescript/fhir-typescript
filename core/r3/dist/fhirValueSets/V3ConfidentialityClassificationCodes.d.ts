 ...
 */
export declare const V3ConfidentialityClassificationCodes: {
    /**
 ...
 *  Set of codes used to value Act.Confidentiality and Role.Confidentiality attribute in accordance with the definition for concept domain "Confidentiality".
 */
export declare type V3ConfidentialityClassificationCodeType = typeof V3ConfidentialityClassificationCodes[keyof typeof V3ConfidentialityClassificationCodes];
//# sourceMappingURL=V3ConfidentialityClassificationCodes.d.ts.map