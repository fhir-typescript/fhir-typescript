 ...
 */
export declare const ClaimTypeCodes: {
    /**
 ...
 * This value set includes sample Claim Type codes.
 */
export declare type ClaimTypeCodeType = typeof ClaimTypeCodes[keyof typeof ClaimTypeCodes];
//# sourceMappingURL=ClaimTypeCodes.d.ts.map