 ...
 */
export declare const NutritionRequestStatusCodes: {
    /**
 ...
 * Codes specifying the state of the request. Describes the lifecycle of the nutrition order.
 */
export declare type NutritionRequestStatusCodeType = typeof NutritionRequestStatusCodes[keyof typeof NutritionRequestStatusCodes];
//# sourceMappingURL=NutritionRequestStatusCodes.d.ts.map