 ...
 */
export declare type ServiceCategoryCodingType = {
    /**
     * 1: Adoption
     */
    Adoption: CodingArgs;
 ...
 * This value set defines an example set of codes that can be used to classify groupings of service-types/specialties.
 */
export declare const ServiceCategoryCodings: ServiceCategoryCodingType;
//# sourceMappingURL=ServiceCategoryCodings.d.ts.map