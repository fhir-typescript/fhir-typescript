 ...
 */
export declare type NutritionRequestStatusCodingType = {
    /**
 ...
 * Codes specifying the state of the request. Describes the lifecycle of the nutrition order.
 */
export declare const NutritionRequestStatusCodings: NutritionRequestStatusCodingType;
//# sourceMappingURL=NutritionRequestStatusCodings.d.ts.map