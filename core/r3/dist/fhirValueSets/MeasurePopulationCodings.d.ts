 ...
 */
export declare type MeasurePopulationCodingType = {
    /**
 ...
 * The type of population
 */
export declare const MeasurePopulationCodings: MeasurePopulationCodingType;
//# sourceMappingURL=MeasurePopulationCodings.d.ts.map