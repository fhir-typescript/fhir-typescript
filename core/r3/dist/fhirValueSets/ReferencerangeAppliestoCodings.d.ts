 ...
 */
export declare type ReferencerangeAppliestoCodingType = {
    /**
 ...
 * This value set defines a set of codes that can be used to indicate the a particular target population the reference range applies to.
 */
export declare const ReferencerangeAppliestoCodings: ReferencerangeAppliestoCodingType;
//# sourceMappingURL=ReferencerangeAppliestoCodings.d.ts.map