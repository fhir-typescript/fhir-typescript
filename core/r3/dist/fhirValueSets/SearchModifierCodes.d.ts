 ...
 */
export declare const SearchModifierCodes: {
    /**
 ...
 * A supported modifier for a search parameter.
 */
export declare type SearchModifierCodeType = typeof SearchModifierCodes[keyof typeof SearchModifierCodes];
//# sourceMappingURL=SearchModifierCodes.d.ts.map