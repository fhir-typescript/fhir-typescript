 ...
 */
export declare const GoalCategoryCodes: {
    /**
 ...
 * Example codes for grouping goals for filtering or presentation.
 */
export declare type GoalCategoryCodeType = typeof GoalCategoryCodes[keyof typeof GoalCategoryCodes];
//# sourceMappingURL=GoalCategoryCodes.d.ts.map