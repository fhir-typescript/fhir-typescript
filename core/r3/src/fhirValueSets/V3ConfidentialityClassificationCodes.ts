...
// FHIR ValueSet: http://hl7.org/fhir/ValueSet/v3-ConfidentialityClassification|2014-03-26
 ...
 */
export const V3ConfidentialityClassificationCodes = {
  /**
 ...
 *  Set of codes used to value Act.Confidentiality and Role.Confidentiality attribute in accordance with the definition for concept domain "Confidentiality".
 */
export type V3ConfidentialityClassificationCodeType = typeof V3ConfidentialityClassificationCodes[keyof typeof V3ConfidentialityClassificationCodes];
