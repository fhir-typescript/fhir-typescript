...
export class Measure extends fhir.DomainResource {
  ...
  constructor(source:Partial<MeasureArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['improvementNotation']) { this.improvementNotation = new fhir.FhirString({value: source.improvementNotation}); }
    if (source['_improvementNotation']) {
      ...
      else { this.improvementNotation = new fhir.FhirString(source._improvementNotation as Partial<fhir.FhirStringArgs>); }
    }
    ...
    if (source['set']) { this.set = new fhir.FhirString({value: source.set}); }
    if (source['_set']) {
      if (this.set) { this.set.addExtendedProperties(source._set!); }
      else { this.set = new fhir.FhirString(source._set as Partial<fhir.FhirStringArgs>); }
    }
