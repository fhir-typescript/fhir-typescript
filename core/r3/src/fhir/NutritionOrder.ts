...
// @ts-ignore
import { TextureVsValidation } from '../fhirValueSets/TextureVsValidation.js';
// @ts-ignore
...
// @ts-ignore
import { ConsistencyTypeVsValidation } from '../fhirValueSets/ConsistencyTypeVsValidation.js';
// @ts-ignore
import { SupplementTypeCodes,  SupplementTypeCodeType } from '../fhirValueSets/SupplementTypeCodes.js';
// @ts-ignore
import { SupplementTypeVsValidation } from '../fhirValueSets/SupplementTypeVsValidation.js';
// @ts-ignore
import { EntformulaTypeCodes,  EntformulaTypeCodeType } from '../fhirValueSets/EntformulaTypeCodes.js';
// @ts-ignore
import { EntformulaTypeVsValidation } from '../fhirValueSets/EntformulaTypeVsValidation.js';
// @ts-ignore
...
export class NutritionOrder extends fhir.DomainResource {
   ...
   * This element is labeled as a modifier because the status contains codes that mark the resource as not currently valid.
   */
  public status?: fhir.FhirCode<NutritionRequestStatusCodeType>|undefined;
  /**
   * The person (patient) who needs the nutrition order for an oral diet, nutritional supplement and/or enteral or formula feeding.
   */
  ...
  constructor(source:Partial<NutritionOrderArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['status'] !== undefined) { this.status = new fhir.FhirCode<NutritionRequestStatusCodeType>({value: source.status}, options); }
    if (source['_status']) {
      if (this.status) { this.status.addExtendedProperties(source._status!); }
      else { this.status = new fhir.FhirCode<NutritionRequestStatusCodeType>(source._status as Partial<fhir.FhirCode>, options); }
    }
