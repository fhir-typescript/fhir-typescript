...
export class PlanDefinitionActionCondition extends fhir.BackboneElement {
  ...
  constructor(source:Partial<PlanDefinitionActionConditionArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['language'] !== undefined) { this.language = new fhir.FhirString({value: source.language}, options); }
    if (source['_language']) {
      if (this.language) { this.language.addExtendedProperties(source._language!); }
      else { this.language = new fhir.FhirString(source._language as Partial<fhir.FhirStringArgs>, options); }
    }
...
export class PlanDefinitionAction extends fhir.BackboneElement {
  ...
  constructor(source:Partial<PlanDefinitionActionArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['triggerDefinition']) { this.triggerDefinition = source.triggerDefinition.map((x) => new fhir.TriggerDefinition(x, options)); }
    ...
    if (source['transform']) { this.transform = new fhir.Reference(source.transform, options); }
...
export class PlanDefinition extends fhir.DomainResource {
  ...
  constructor(source:Partial<PlanDefinitionArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['library']) { this.library = source.library.map((x) => new fhir.Reference(x, options)); }
    else { this.library = []; }
