...
export class ServiceDefinition extends fhir.DomainResource {
   ...
   */
  public static override readonly _fts_dataType:string = 'ServiceDefinition';
  /**
   * Resource Type Name
   */
  public override resourceType: "ServiceDefinition";
  /**
   * Can be a urn:uuid: or a urn:oid:, but real http: addresses are preferred.  Multiple instances may share the same url if they have a distinct version.
   */
   ...
   * A reference to the operation that is used to invoke this service.
   */
  public operationDefinition?: fhir.Reference|undefined;
  /**
