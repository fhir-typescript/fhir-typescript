...
export class ElementDefinitionType extends fhir.FhirElement {
  ...
  constructor(source:Partial<ElementDefinitionTypeArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['targetProfile'] !== undefined) { this.targetProfile = new fhir.FhirUri({value: source.targetProfile}, options); }
    if (source['_targetProfile']) {
      if (this.targetProfile) { this.targetProfile.addExtendedProperties(source._targetProfile!); }
      else { this.targetProfile = new fhir.FhirUri(source._targetProfile as Partial<fhir.FhirUriArgs>, options); }
    }
