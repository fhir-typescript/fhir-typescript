...
export class TestScriptOrigin extends fhir.BackboneElement {
  ...
  constructor(source:Partial<TestScriptOriginArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['index'] !== undefined) { this.index = new fhir.FhirInteger({value: source.index}, options); }
    else { this.index = null; }
    if (source['_index']) {
      if (this.index) { this.index.addExtendedProperties(source._index!); }
      else { this.index = new fhir.FhirInteger(source._index as Partial<fhir.FhirIntegerArgs>, options); }
    }
    if (source['profile']) { this.profile = new fhir.Coding(source.profile, options); }
...
export class TestScriptDestination extends fhir.BackboneElement {
  ...
  public override doModelValidation(exp:string = ''):fhir.FtsIssue[] {
    let iss:fhir.FtsIssue[] = super.doModelValidation(exp);
    if (exp === '') { exp = 'TestScript.destination' }
    iss.push(...this.vRS('index',exp));
    iss.push(...this.vRS('profile',exp));
    return iss;
  }
...
export class TestScriptMetadataCapability extends fhir.BackboneElement {
   ...
   * The conformance statement of the server has to contain at a minimum the contents of the reference pointed to by this element.
   */
  public capabilities: fhir.Reference|null;
  /**
  ...
  constructor(source:Partial<TestScriptMetadataCapabilityArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['origin'] !== undefined) { this.origin = source.origin.map((x) => new fhir.FhirInteger({value: x}, options)); }
    else { this.origin = []; }
    if (source['_origin']) {
    ...
    if (source['capabilities']) { this.capabilities = new fhir.Reference(source.capabilities, options); }
...
export class TestScriptVariable extends fhir.BackboneElement {
  ...
  constructor(source:Partial<TestScriptVariableArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['defaultValue'] !== undefined) { this.defaultValue = new fhir.FhirString({value: source.defaultValue}, options); }
    if (source['_defaultValue']) {
      if (this.defaultValue) { this.defaultValue.addExtendedProperties(source._defaultValue!); }
      else { this.defaultValue = new fhir.FhirString(source._defaultValue as Partial<fhir.FhirStringArgs>, options); }
    }
    if (source['description'] !== undefined) { this.description = new fhir.FhirString({value: source.description}, options); }
    if (source['_description']) {
      if (this.description) { this.description.addExtendedProperties(source._description!); }
    ...
    if (source['hint'] !== undefined) { this.hint = new fhir.FhirString({value: source.hint}, options); }
    if (source['_hint']) {
      if (this.hint) { this.hint.addExtendedProperties(source._hint!); }
      else { this.hint = new fhir.FhirString(source._hint as Partial<fhir.FhirStringArgs>, options); }
    }
...
export class TestScriptRuleParam extends fhir.BackboneElement {
   ...
   * Mapping of this datatype to a FHIR equivalent
   */
  public static override readonly _fts_dataType:string = 'TestScriptRuleParam';
  /**
   * The external rule template would be looking for the parameter by this name.
   */
  public name: fhir.FhirString|null;
  ...
  public override doModelValidation(exp:string = ''):fhir.FtsIssue[] {
    let iss:fhir.FtsIssue[] = super.doModelValidation(exp);
    if (exp === '') { exp = 'TestScript.rule.param' }
    iss.push(...this.vRS('name',exp));
...
export class TestScriptRule extends fhir.BackboneElement {
   ...
   * Mapping of this datatype to a FHIR equivalent
   */
  public static override readonly _fts_dataType:string = 'TestScriptRule';
  /**
   * Reference to the resource (containing the contents of the rule needed for assertions).
   */
   ...
   * The parameter value can be dynamic at runtime.
   */
  public param: fhir.TestScriptRuleParam[];
  /**
  ...
  constructor(source:Partial<TestScriptRuleArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['param']) { this.param = source.param.map((x) => new fhir.TestScriptRuleParam(x, options)); }
    else { this.param = []; }
  }
  /**
   * Function to perform basic model validation (e.g., check if required elements are present).
...
export class TestScriptRulesetRuleParam extends fhir.BackboneElement {
   ...
   * Mapping of this datatype to a FHIR equivalent
   */
  public static override readonly _fts_dataType:string = 'TestScriptRulesetRuleParam';
  /**
   * The external rule template would be looking for the parameter by this name.
   */
  public name: fhir.FhirString|null;
  ...
  public override doModelValidation(exp:string = ''):fhir.FtsIssue[] {
    let iss:fhir.FtsIssue[] = super.doModelValidation(exp);
    if (exp === '') { exp = 'TestScript.ruleset.rule.param' }
    iss.push(...this.vRS('name',exp));
    iss.push(...this.vOS('value',exp));
    return iss;
  }
...
export class TestScriptRulesetRule extends fhir.BackboneElement {
   ...
   * Mapping of this datatype to a FHIR equivalent
   */
  public static override readonly _fts_dataType:string = 'TestScriptRulesetRule';
  /**
   * Id of the referenced rule within the external ruleset template.
   */
  public ruleId: fhir.FhirId|null;
  /**
   * The parameter value can be dynamic at runtime.
   */
  public param: fhir.TestScriptRulesetRuleParam[];
  /**
  ...
  constructor(source:Partial<TestScriptRulesetRuleArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    super(source, options);
    if (source['ruleId'] !== undefined) { this.ruleId = new fhir.FhirId({value: source.ruleId}, options); }
    else { this.ruleId = null; }
    if (source['_ruleId']) {
      if (this.ruleId) { this.ruleId.addExtendedProperties(source._ruleId!); }
      else { this.ruleId = new fhir.FhirId(source._ruleId as Partial<fhir.FhirIdArgs>, options); }
    }
    if (source['param']) { this.param = source.param.map((x) => new fhir.TestScriptRulesetRuleParam(x, options)); }
    else { this.param = []; }
  }
  /**
   * Function to perform basic model validation (e.g., check if required elements are present).
  ...
  public override doModelValidation(exp:string = ''):fhir.FtsIssue[] {
    let iss:fhir.FtsIssue[] = super.doModelValidation(exp);
    if (exp === '') { exp = 'TestScript.ruleset.rule' }
...
export class TestScriptRuleset extends fhir.BackboneElement {
   ...
   * Mapping of this datatype to a FHIR equivalent
   */
  public static override readonly _fts_dataType:string = 'TestScriptRuleset';
  /**
   * Reference to the resource (containing the contents of the ruleset needed for assertions).
   */
  public resource: fhir.Reference|null;
   ...
   * This qualifies each param name so that  a parameter with the same name can be used differently by the different rules with the ruleset.
   */
  public rule: fhir.TestScriptRulesetRule[];
  /**
  ...
  constructor(source:Partial<TestScriptRulesetArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['rule']) { this.rule = source.rule.map((x) => new fhir.TestScriptRulesetRule(x, options)); }
    else { this.rule = []; }
  }
  /**
   * Function to perform basic model validation (e.g., check if required elements are present).
...
export class TestScriptSetupActionOperation extends fhir.BackboneElement {
  ...
  constructor(source:Partial<TestScriptSetupActionOperationArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['origin'] !== undefined) { this.origin = new fhir.FhirInteger({value: source.origin}, options); }
    if (source['_origin']) {
      if (this.origin) { this.origin.addExtendedProperties(source._origin!); }
      else { this.origin = new fhir.FhirInteger(source._origin as Partial<fhir.FhirIntegerArgs>, options); }
    }
    ...
    if (source['requestId'] !== undefined) { this.requestId = new fhir.FhirId({value: source.requestId}, options); }
    if (source['_requestId']) {
      if (this.requestId) { this.requestId.addExtendedProperties(source._requestId!); }
      else { this.requestId = new fhir.FhirId(source._requestId as Partial<fhir.FhirIdArgs>, options); }
    }
...
export class TestScriptSetupActionAssertRuleParam extends fhir.BackboneElement {
   ...
   * Mapping of this datatype to a FHIR equivalent
   */
  public static override readonly _fts_dataType:string = 'TestScriptSetupActionAssertRuleParam';
  /**
   * The external rule template would be looking for the parameter by this name.
   */
  public name: fhir.FhirString|null;
  ...
  public override doModelValidation(exp:string = ''):fhir.FtsIssue[] {
    let iss:fhir.FtsIssue[] = super.doModelValidation(exp);
    if (exp === '') { exp = 'TestScript.setup.action.assert.rule.param' }
    iss.push(...this.vRS('name',exp));
    iss.push(...this.vRS('value',exp));
    return iss;
  }
...
export class TestScriptSetupActionAssertRule extends fhir.BackboneElement {
   ...
   * Mapping of this datatype to a FHIR equivalent
   */
  public static override readonly _fts_dataType:string = 'TestScriptSetupActionAssertRule';
  /**
   * The TestScript.rule id value this assert will evaluate.
   */
  public ruleId: fhir.FhirId|null;
   ...
   * The parameter value can be dynamic at runtime.
   */
  public param: fhir.TestScriptSetupActionAssertRuleParam[];
  /**
  ...
  constructor(source:Partial<TestScriptSetupActionAssertRuleArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['param']) { this.param = source.param.map((x) => new fhir.TestScriptSetupActionAssertRuleParam(x, options)); }
    else { this.param = []; }
  }
  /**
   * Function to perform basic model validation (e.g., check if required elements are present).
  ...
  public override doModelValidation(exp:string = ''):fhir.FtsIssue[] {
    let iss:fhir.FtsIssue[] = super.doModelValidation(exp);
    if (exp === '') { exp = 'TestScript.setup.action.assert.rule' }
    iss.push(...this.vRS('ruleId',exp));
    iss.push(...this.vOA('param',exp));
    return iss;
  }
...
export class TestScriptSetupActionAssertRulesetRuleParam extends fhir.BackboneElement {
   ...
   * Mapping of this datatype to a FHIR equivalent
   */
  public static override readonly _fts_dataType:string = 'TestScriptSetupActionAssertRulesetRuleParam';
  /**
   * The external rule template would be looking for the parameter by this name.
   */
  public name: fhir.FhirString|null;
  ...
  public override doModelValidation(exp:string = ''):fhir.FtsIssue[] {
    let iss:fhir.FtsIssue[] = super.doModelValidation(exp);
    if (exp === '') { exp = 'TestScript.setup.action.assert.ruleset.rule.param' }
    iss.push(...this.vRS('name',exp));
    iss.push(...this.vRS('value',exp));
    return iss;
  }
...
export class TestScriptSetupActionAssertRulesetRule extends fhir.BackboneElement {
   ...
   * Mapping of this datatype to a FHIR equivalent
   */
  public static override readonly _fts_dataType:string = 'TestScriptSetupActionAssertRulesetRule';
  /**
   * Id of the referenced rule within the external ruleset template.
   */
  public ruleId: fhir.FhirId|null;
   ...
   * The parameter value can be dynamic at runtime.
   */
  public param: fhir.TestScriptSetupActionAssertRulesetRuleParam[];
  /**
  ...
  constructor(source:Partial<TestScriptSetupActionAssertRulesetRuleArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['param']) { this.param = source.param.map((x) => new fhir.TestScriptSetupActionAssertRulesetRuleParam(x, options)); }
    else { this.param = []; }
  }
  /**
   * Function to perform basic model validation (e.g., check if required elements are present).
  ...
  public override doModelValidation(exp:string = ''):fhir.FtsIssue[] {
    let iss:fhir.FtsIssue[] = super.doModelValidation(exp);
    if (exp === '') { exp = 'TestScript.setup.action.assert.ruleset.rule' }
    iss.push(...this.vRS('ruleId',exp));
    iss.push(...this.vOA('param',exp));
    return iss;
  }
...
export class TestScriptSetupActionAssertRuleset extends fhir.BackboneElement {
   ...
   * Mapping of this datatype to a FHIR equivalent
   */
  public static override readonly _fts_dataType:string = 'TestScriptSetupActionAssertRuleset';
  /**
   * The TestScript.ruleset id value this assert will evaluate.
   */
  public rulesetId: fhir.FhirId|null;
  /**
   * This qualifies each param name so that  a parameter with the same name can be used differently by the different rules with the ruleset.
   */
  public rule: fhir.TestScriptSetupActionAssertRulesetRule[];
  /**
  ...
  constructor(source:Partial<TestScriptSetupActionAssertRulesetArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    super(source, options);
    if (source['rulesetId'] !== undefined) { this.rulesetId = new fhir.FhirId({value: source.rulesetId}, options); }
    else { this.rulesetId = null; }
    if (source['_rulesetId']) {
      if (this.rulesetId) { this.rulesetId.addExtendedProperties(source._rulesetId!); }
      else { this.rulesetId = new fhir.FhirId(source._rulesetId as Partial<fhir.FhirIdArgs>, options); }
    }
    if (source['rule']) { this.rule = source.rule.map((x) => new fhir.TestScriptSetupActionAssertRulesetRule(x, options)); }
    else { this.rule = []; }
  }
  /**
   * Function to perform basic model validation (e.g., check if required elements are present).
  ...
  public override doModelValidation(exp:string = ''):fhir.FtsIssue[] {
    let iss:fhir.FtsIssue[] = super.doModelValidation(exp);
    if (exp === '') { exp = 'TestScript.setup.action.assert.ruleset' }
...
export class TestScriptSetupActionAssert extends fhir.BackboneElement {
   ...
   * Each rule should get evaluated by test engines as one assertion regardless of how many assertions are contained within the external rule template.  The impact of negative rule evaluation on test script execution is the same as an assertion failure which is descibed elsewhere in the TestScript resource.
   */
  public rule?: fhir.TestScriptSetupActionAssertRule|undefined;
  /**
   * Each rule within a ruleset should get evaluated by test engines as a separate assertion.  The impact of negative rule evaluation on test script execution is the same as an assertion failure which is descibed elsewhere in the TestScript resource.  If the first rule within the ruleset results in a failed assertion, then test engines do not have to evaluate the rest of the rules within the ruleset.
   */
  public ruleset?: fhir.TestScriptSetupActionAssertRuleset|undefined;
  /**
   * This can be a statically defined fixture (at the top of the testscript) or a dynamically set fixture created by responseId of the action.operation element.
   */
  public sourceId?: fhir.FhirId|undefined;
  ...
  constructor(source:Partial<TestScriptSetupActionAssertArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['compareToSourceExpression'] !== undefined) { this.compareToSourceExpression = new fhir.FhirString({value: source.compareToSourceExpression}, options); }
    if (source['_compareToSourceExpression']) {
      ...
      else { this.compareToSourceExpression = new fhir.FhirString(source._compareToSourceExpression as Partial<fhir.FhirStringArgs>, options); }
    }
    ...
    if (source['requestMethod'] !== undefined) { this.requestMethod = new fhir.FhirCode<HttpOperationsCodeType>({value: source.requestMethod}, options); }
    if (source['_requestMethod']) {
      if (this.requestMethod) { this.requestMethod.addExtendedProperties(source._requestMethod!); }
      else { this.requestMethod = new fhir.FhirCode<HttpOperationsCodeType>(source._requestMethod as Partial<fhir.FhirCode>, options); }
    }
    if (source['requestURL'] !== undefined) { this.requestURL = new fhir.FhirString({value: source.requestURL}, options); }
    if (source['_requestURL']) {
      if (this.requestURL) { this.requestURL.addExtendedProperties(source._requestURL!); }
      else { this.requestURL = new fhir.FhirString(source._requestURL as Partial<fhir.FhirStringArgs>, options); }
    }
    if (source['resource'] !== undefined) { this.resource = new fhir.FhirCode({value: source.resource}, options); }
    if (source['_resource']) {
      if (this.resource) { this.resource.addExtendedProperties(source._resource!); }
    ...
    if (source['rule']) { this.rule = new fhir.TestScriptSetupActionAssertRule(source.rule, options); }
    if (source['ruleset']) { this.ruleset = new fhir.TestScriptSetupActionAssertRuleset(source.ruleset, options); }
    if (source['sourceId'] !== undefined) { this.sourceId = new fhir.FhirId({value: source.sourceId}, options); }
    if (source['_sourceId']) {
      if (this.sourceId) { this.sourceId.addExtendedProperties(source._sourceId!); }
      else { this.sourceId = new fhir.FhirId(source._sourceId as Partial<fhir.FhirIdArgs>, options); }
...
export class TestScript extends fhir.DomainResource {
   ...
   * Each rule should be treated by test engines as one assertion regardless of how many assertions are contained within the external rule template.  The impact of negative rule evaluation on test script execution is the same as an assertion failure which is described elsewhere in the TestScript resource.
   */
  public rule: fhir.TestScriptRule[];
  /**
   * Each rule within a ruleset should be treated by test engines as one assertion regardless of how many assertions are contained within the external rule template.  The impact of negative rule evaluation on test script execution is the same as an assertion failure which is described elsewhere in the TestScript resource.
   */
  public ruleset: fhir.TestScriptRuleset[];
  /**
   * A series of required setup operations before tests are executed.
   */
  ...
  constructor(source:Partial<TestScriptArgs> = {}, options:fhir.FhirConstructorOptions = {}) {
    ...
    if (source['origin']) { this.origin = source.origin.map((x) => new fhir.TestScriptOrigin(x, options)); }
    else { this.origin = []; }
    if (source['destination']) { this.destination = source.destination.map((x) => new fhir.TestScriptDestination(x, options)); }
    ...
    if (source['rule']) { this.rule = source.rule.map((x) => new fhir.TestScriptRule(x, options)); }
    else { this.rule = []; }
    if (source['ruleset']) { this.ruleset = source.ruleset.map((x) => new fhir.TestScriptRuleset(x, options)); }
    else { this.ruleset = []; }
